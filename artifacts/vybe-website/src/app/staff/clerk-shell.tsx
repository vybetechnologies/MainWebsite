...
// Loaded exclusively in the browser (ssr: false via staff-client-layout.tsx).
// Safe to use ClerkProvider here because this module never executes during
// the static-export build pass.
