...
// Appearance constants — kept at module scope (no window access needed here).
...
// @clerk/react's ClerkProvider is safe to render unconditionally here —
// it handles the server / static-export build pass by deferring all browser
// API access internally.  No window checks, no dynamic imports, no
// useState+useEffect needed.  Those patterns introduced tree-teardown timing
// gaps that prevented <SignIn> from mounting inside the provider context.
